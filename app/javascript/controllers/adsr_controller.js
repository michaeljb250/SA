...
export default class extends Controller {
  connect() {
    ...
    const textArrayy = [
      ...
      { textt: "ADSR is about understanding how the different parameters interact and using them creatively to craft sounds that evoke emotions and tell stories.", duration: 10000 },

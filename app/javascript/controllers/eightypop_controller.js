...
export default class extends Controller {
  connect() {
    ...
    const sounds = [
      new Howl({
        src: ['https://soundacademybucket.s3.ap-southeast-2.amazonaws.com/80poppiano.mp3'],
        spatial: true,
        preload: true, // Preload the audio
      }),
      new Howl({
        src: ['https://soundacademybucket.s3.ap-southeast-2.amazonaws.com/80poppiano2.mp3'],
        spatial: true,
        preload: true, // Preload the audio
      }),
      new Howl({
        src: ['https://soundacademybucket.s3.ap-southeast-2.amazonaws.com/80popdrum.mp3'],
        spatial: true,
        preload: true, // Preload the audio
      }),
      new Howl({
        src: ['https://soundacademybucket.s3.ap-southeast-2.amazonaws.com/80popbass.mp3'],
        spatial: true,
        preload: true, // Preload the audio
      }),
    ];

...
export default class extends Controller {
  connect() {
    ...
    const scales = {
      C: ["C4", "D#4", "F4", "F#4", "G4", "A#4"],
      D: ["D4", "F4", "G4", "G#4", "A4", "C5"],
      E: ["E4", "G4", "A4", "A#4", "B4", "D5"],
      F: ["F4", "G#4", "A#4", "B4", "C5", "D#5"],
      G: ["G4", "A#4", "C5", "C#5", "D5", "F5"],
      A: ["A4", "C5", "D5", "D#5", "E5", "G5"],
      B: ["B4", "D5", "E5", "F5", "F#5", "A5"]
    };
    ...
    let grid = Array.from({ length: 6 }, () => Array(8).fill(false));
    let loop;
    ...
    function handleScaleChange() {
      ...
      grid = Array.from({ length: 6 }, () => Array(8).fill(false)); // Reset the grid
      updateGridUI();
    }

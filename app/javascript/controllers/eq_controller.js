...
document.getElementById('stop-btn').addEventListener('click', () => {
  player.stop();
    ...
    let indexx = 0;
    const textArrayy = [
      { textt: "Equalization is all about finding the sweet spot for each instrument. Try and bring out the character of a sound by highlighting the frequencies that make it shine", duration: 10000 },
      { textt: "Equalization is a powerful tool, but it should be used with precision and intention. Don't just EQ for the sake of EQing", duration: 10000 },
